...
for mood_state in mood_states:
    motion_sickness.loc[:, f'Change_{mood_state}'] = motion_sickness[f'After {mood_state}'] - motion_sickness[f'Before {mood_state}']
    no_motion_sickness.loc[:, f'Change_{mood_state}'] = no_motion_sickness[f'After {mood_state}'] - no_motion_sickness[f'Before {mood_state}']
...
def analyze_and_plot(group_data, group_name):
    ...
    for mood in mood_states:
        ...
        for condition in group_data['Condition_x'].unique():
            ...
            condition_diff = condition_data[f'Change_{mood}']  # Use Change_ instead of Difference_
